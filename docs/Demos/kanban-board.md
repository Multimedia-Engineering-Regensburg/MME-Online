...
Ein vorbereitetes Starterpaket zur selbständigen Implementierung der Aufgabe finden Sie [hier](https://elearning.uni-regensburg.de/mod/resource/view.php?id=1042483). Einen Lösungsvorschlag finden Sie [hier](https://elearning.uni-regensburg.de/mod/resource/view.php?id=1042484).
